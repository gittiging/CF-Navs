...
- ✅ 自定义背景（浅色/深色主题分别配置纯色/渐变/图片），并内置 13 组可持久化选择的跨色系渐变方案
- ✅ 遮罩颜色与透明度后台可调
- ✅ 卡片背景颜色与透明度后台可调
...
- ✅ 站点设置管理（基础信息、外观主题、布局与导航、标题与搜索、卡片样式、搜索引擎、自定义页脚、账号安全分组，带锚点导航）
...
- 书签卡片与后台侧栏使用毛玻璃效果（`backdrop-filter`），亮暗模式分别维持清晰的文字层级
- 柔和的阴影和过渡动画
- 响应式网格布局
- 移动端优化
